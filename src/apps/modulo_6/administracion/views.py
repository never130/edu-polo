...
def estadisticas_detalladas(request):
    ...
    context = {
        ...
        'asistencia_semanal_json': json.dumps(asistencia_semanal),
        'demanda_oferta_json': json.dumps(demanda_oferta),
        'ocupacion_asistencia_json': json.dumps(ocupacion_asistencia),
    }
